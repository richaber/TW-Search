...
namespace TwisterMc\TWSearch\Vendor\League\Container\ServiceProvider;

use Generator;
use TwisterMc\TWSearch\Vendor\League\Container\{ContainerAwareInterface, ContainerAwareTrait};
use TwisterMc\TWSearch\Vendor\League\Container\Exception\ContainerException;
